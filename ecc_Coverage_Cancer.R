...
aa_d <- aa[grep(pattern = "[^Healthy]",aa[,"Disease"]),c("Coordinate.hg19.","eccDNA_ID","Disease","Identify_method")]
aa_d <- aa_d[grep(pattern = "ATAC",aa_d[,"Identify_method"]),c("Coordinate.hg19.","eccDNA_ID","Disease")]
aa_d <- aa_d[grep(pattern = "Ovarian",aa_d[,"Disease"]),c("Coordinate.hg19.","eccDNA_ID","Disease")]
...
#aa_d$Identify_method
###开始作图
#jpeg("kpPlotCoverage_Healthy.jpg",res=400, width = 2000, height = 3000)
#jpeg("kpPlotCoverage_Cancer_Manually.jpg",res=400, width = 2000, height = 3000)
