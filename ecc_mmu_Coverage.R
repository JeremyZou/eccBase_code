...
aa_d <- aa[,c("Coordinate.mm10.","eccDNA_ID","Disease")]
...
jpeg("kpPlotCoverage_Healthy_mmu.jpg",res=400, width = 2000, height = 3000)
kp <- plotKaryotype(genome="mm10", plot.type=1, cex=1)
kpAxis(kp, cex=0.01,numticks=2, labels=NA)
kp <- kpPlotCoverage(kp, data=aa_G,show.0.cov = F, ymax = 30)
