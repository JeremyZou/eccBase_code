...
repCla_frac$mark <- factor(repCla_frac$mark, levels = repCla_frac$mark)
...
myplot_ltr
getwd()
ggsave(myplot_ltr,filename = "tempTissues_mmu/1_ltr_repClassrepFamily.jpg",
       dpi = 800, units = "cm", width = 20, height = 7)
